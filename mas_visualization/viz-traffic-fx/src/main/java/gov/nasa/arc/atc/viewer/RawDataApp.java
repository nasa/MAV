 ...
 * @author ahamon
 */
public class RawDataApp implements ManagedApp {

    private static final Logger LOG = Logger.getGlobal();
    private static final String DISPLAY_NAME = "Raw Data Viewer";

    private final PropertyChangeSupport propertyChangeSupport;
    private final Stage stage;

    private RawViewerController viewerController;

    /**
     * Creates the frame for displaying the data blocks from the log file parsed
     */
    public RawDataApp() {
        propertyChangeSupport = new PropertyChangeSupport(RawDataApp.this);
        ...
        stage = new Stage();
        runLater(RawDataApp.this::createApp);
    }
    ...
    private void createApp() {
        ...
        try {
            FXMLLoader fXMLLoader = new FXMLLoader(getClass().getResource("RawDataViewer.fxml"));
            fXMLLoader.load();
