...
public class CreateAreaActivity extends Activity {

	public CreateAreaActivity(String name, String display, int max_duration,
	...
	public CreateAreaActivity(Value name, Value display, Value max_duration,
