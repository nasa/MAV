...
public class PrintlnActivity extends AbstractExternalActivity{

	final static Logger LOGGER = Logger.getLogger(PrintlnActivity.class);

	
	@Override
	public void doActivity() throws ExternalException {
		LOGGER.error("need to implmeent println activity");
	}
