...
public class UpdateTSSTimeline extends AbstractExternalActivity {

	public final static Logger LOGGER = Logger.getLogger(UpdateTSSTimeline.class);
	...
	public void doActivity() throws ExternalException {
		...
		synchronized (instance) {
			...
			System.out.print("UpdateTSSTimeline::doActivity([ ");
