 ...
 *
 */
public class DSASCreator implements AlgorithmCreator {

	private static final String FXML_NAME = "ParametricDSASCreator.fxml";
	private static final Logger LOG = Logger.getGlobal();

	private static final String HELP_MESSAGE = "A DSAS algorithm needs: \n" + 
			" - a function to modify the arrival gaps";

	private Node rootNode;
	private ParametricDSASCreatorFxControler controller;
